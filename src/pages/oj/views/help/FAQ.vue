    ...
    <div class="content markdown-body">
      <ul>
        ...
        <li>{{$t('m.How_to_report_bugs')}}
          <p>{{$t('m.How_to_report_bugs_answer_part_1')}} <a href="https://github.com/QingdaoU/OnlineJudge" target="_blank">Github</a>
            {{$t('m.How_to_report_bugs_answer_part_2')}} <a href="http://t.me/xcoderuz_bot" target="_blank">telegram bot</a>
            {{$t('m.How_to_report_bugs_answer_part_3')}}
          </p>
        </li>
      </ul>
    </div>
